...
class EnrichSchedule:
    ...
    def parse_json_string(self, json_string):
    	...
    	for i in range(0, x, 1):
    		...
    		print('{} [{}] [{}] {} {}'.format(current_tiploc, line_out, next_path_in, next_tiploc, self.return_options(current_tiploc, next_tiploc)))


    	schedule_list = enumerate(js['schedule_line'])
    	print(schedule_list)
    	# for key, value in enumerate(js['schedule_line']):
    	# 	print(key, value)
