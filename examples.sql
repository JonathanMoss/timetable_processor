...
ifnull((SELECT 
tbl_location.txt_tps_description 
FROM 
tbl_location 
WHERE 
trim(tbl_location.txt_tiploc) = trim(substr(tbl_origin.txt_location_and_suffix, 1, 7)) LIMIT 1), 
tbl_origin.txt_location_and_suffix)
END as Origin,
